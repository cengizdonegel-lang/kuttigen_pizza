...
export class AppConfigComponent implements OnInit {
    ...
    ngOnInit() {
        ...
        this.scenes = [
            ...
            { sceneName: 'Ambers', colorScheme: 'light', colorSchemeColor: '#EFEFEF', menuTheme: 'light', menuThemeColor: '#252129', componentTheme: 'green', componentThemeColor: '#07ff3d', topbarTheme: 'yellow', topbarThemeColor: '#2dd5fb', menuMode: 'horizontal', cardColor: '#ffffff' },
