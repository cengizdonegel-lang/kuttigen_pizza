...
import { Customer, Representative } from 'src/app/charisma/api/customer';
import { CustomerService } from 'src/app/charisma/service/customer.service';
...
@Component({
    templateUrl: './tablecharisma.component.html',
    providers: [MessageService, ConfirmationService]
})
export class TablecharismaComponent implements OnInit {
