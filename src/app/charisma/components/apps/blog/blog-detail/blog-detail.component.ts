...
import { Comment } from 'src/app/charisma/api/blog';
...
export class BlogDetailComponent {
    ...
    comments: Comment[] = [
        {
            image: "assets/charisma/images/avatar/circle/avatar-f-3@2x.png",
            name: "Courtney Henry",
            date: "03 February 2022",
            description: "Reprehenderit ut voluptas sapiente ratione nostrum est."
        },
        {
            image: "assets/charisma/images/avatar/circle/avatar-f-1@2x.png",
            name: "Esther Howard",
            date: "03 February 2022",
